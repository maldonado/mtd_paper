...
barplot(as.matrix(mydata),  ylab="Percentage",  ylim=c(0, 100), beside=TRUE, col=1, density=c(13,8,8,3,3), angle = c(0, 50, 90, 140, 180))
legend(23, 92, c("Design debt", "Requirement debt", "Defect debt","Test debt", "Documentation debt"), cex=1.3, col=1, density=c(18,13,13,8,8), angle = c(0, 50, 90, 140, 180) , bty="y", seg.len=0.5)
