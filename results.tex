...
\begin{itemize}
  ...
  This comments indicates that there is a problem with the design of the code. Comments about misplaced code, lack of abstraction, long methods, poor implementation, workarounds and temporary solution were classified in this type. Lets consider the following comments:
  ...
  \item \textbf{Defect debt:} In defect debt comments the author states that that particular piece of code do not have the expected behavior.
  \vspace{1mm}
  \begin{displayquote}
      \textit{``''}
  ...
  \item \textbf{Documentation debt:} For documentation debt comments the author wrote that there is not documentation supporting that part of the program.

  \item \textbf{Requirement debt:} Requirement debt comments express the fact that incompleteness of the method, class or program.

  \item \textbf{Test debt:} Test debt comments are the ones that express the need for implementation or improvement of the current tests.
\end{itemize}
