...
\begin{table}[!hbt]
      \begin{center}
            ...
            \toprule
            \thead{Project}   & \thead{\# of comments \\before \\filtering}  & \thead{\# of comments \\after \\filtering} & \thead{\%  of comments \\remained}\\ \midrule 
