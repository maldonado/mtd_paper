...
\begin{table}[!hbt]
      \begin{center}
            ...
            \textbf{Project}   & \textbf{\# of comments}  & \textbf{\# after filtering} & \textbf{\%}\\ \midrule 
              Apache Ant       & 21,587                & 4,140                   & 80.82 \% \\ 
              Apache Jmeter    & 20,084                & 8,163                   & 59.35 \% \\
              ArgoUML          & 67,716                & 9,788                   & 85.54 \% \\              
              Columba          & 33,895                & 6,569                   & 80.61 \% \\
              JFreeChart       & 23,474                & 4,436                   & 81.10 \% \\ \bottomrule
            \end{tabular}
      \end{center}
\end{table}
